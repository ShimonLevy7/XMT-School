...
namespace XmtSchoolTypes.Users
{
	...
	public class User
	{
		...
		public bool SanityCheck()
		{
			...
			// Optionally check if avatar Url is null.
/*			if (string.IsNullOrEmpty(AvatarUrl) || !Utilities.IsValidImageUrl(AvatarUrl))
				throw new Exception($"Invalid image URL, received: {AvatarUrl}");*/
